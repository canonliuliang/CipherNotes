...
sed "s|../outputs/密笺安装器.pkg|密笺-${CIPHERNOTES_VERSION}.pkg|g; s|../outputs/密笺-macOS.zip|密笺-${CIPHERNOTES_VERSION}.zip|g; s|密笺-<version>-普通版.pkg|密笺-${CIPHERNOTES_VERSION}.pkg|g; s|密笺-<version>-普通版.zip|密笺-${CIPHERNOTES_VERSION}.zip|g" "$ROOT_DIR/Website/index.html" > "$OUTPUTS_DIR/产品介绍.html"

NORMAL_PKG="$OUTPUTS_DIR/密笺-${CIPHERNOTES_VERSION}.pkg"
